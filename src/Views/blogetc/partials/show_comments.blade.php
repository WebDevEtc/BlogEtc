@switch(config('blogetc.comments.type_of_comments_to_show'))
    @case(\WebDevEtc\BlogEtc\Services\BlogEtcCommentsService::COMMENT_TYPE_BUILT_IN)
    {{-- default - show our own comments--}}
    @include('blogetc::partials.built_in_comments')
    @include('blogetc::partials.add_comment_form')
    @break

    @case(\WebDevEtc\BlogEtc\Services\BlogEtcCommentsService::COMMENT_TYPE_DISQUS)
    {{--use disqus--}}
    @include('blogetc::partials.disqus_comments')
    @break


    @case(\WebDevEtc\BlogEtc\Services\BlogEtcCommentsService::COMMENT_TYPE_CUSTOM)
    ...
    @case(\WebDevEtc\BlogEtc\Services\BlogEtcCommentsService::COMMENT_TYPE_DISABLED)
